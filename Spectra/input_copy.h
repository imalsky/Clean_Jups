...
/* File names */
#define OUTPUT_PREFIX "OUT/180_90_"       /* output name */
#define T_P_3D_FILE "DATA/full_final_t_p_3D_180_sorted_1.570795.dat"   /* input file */
...
#define NLON  195            /* Number of longitude points in 3-D grid */

#define NTEMP 30             /* Number of temperature points in grid   */
#define NPRESSURE 13         /* Number of pressure points in grid   [13/17]   */
#define NLAMBDA 6700         /* Number of wavelength points in grid [4616/2598]   */

/* Planet parameters */

#define G 24.79              /* Planet surface gravity                 */
#define R_PLANET 6.99e+07   /* Planet radius at base of atmosphere    */
#define R_STAR 6.957e+07     /* Stellar radius                         */

#define P_ROT 3.525       /* Rotation period in days
		        	(= P_ORB for tidally locked planet)    */
